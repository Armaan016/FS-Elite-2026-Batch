...
public class ClassDesign {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            Customer customer = new Customer(name, income, debt, missedPayments);
            RiskAnalyzer riskAnalyzer = new CreditRiskAnalyzerImpl();
            CreditReport report = riskAnalyzer.analyzeRisk(customer);
...
class CreditRiskAnalyzerImpl implements RiskAnalyzer {
    ...
    public CreditReport analyzeRisk(Customer customer) {
        ...
        // - Debt Score = 1 - min(1, debt / 50000)
        // - Missed Payments Score = 1 - min(1, missedPayments / 10)
        // - Final Score = (0.4 × Income Score) + (0.4 × Debt Score) + (0.2 × Missed
        // Payment Score) × 100
