...
public class Subnet5 {
    public static void main(String[] args) {
        ...
        System.out.println(checkOverlap(ip1, cidr1, ip2, cidr2));

        sc.close();
    }

    private static boolean checkOverlap(String ip1, int cidr1, String ip2, int cidr2) {
        ...
        int network1 = ipInt1 & mask1;
        int network2 = ipInt2 & mask2;
