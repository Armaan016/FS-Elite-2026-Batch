...
public class GoldBiscuits {
    public static void main(String[] args) {
        ...
        System.out.println(findMaxGold(golds));
        sc.close();
    }

    private static int findMaxGold(int[] golds) {
        Arrays.sort(golds);
        int l = 0, r = golds.length - 1;

        // System.out.println("Sorted: " + Arrays.toString(golds));
        int rancho = 0;
        while (l < r) {
            r--;
            l++;
