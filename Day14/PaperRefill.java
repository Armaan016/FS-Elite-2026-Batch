...
// Initially, Trivikram has T number of papers in his box and Vamshi has V
// number of
// papers in his box. They have started the screenplay writing in the following
// way:
// - Trivikram starts from screen-play number 1 to N and Vamshi starts from N to
// 1.
...
// You are given 1-indexed integer array screen-play[] of size N, where
// screen-play[i]
// is the number of papers required for ith screen-play, and two integers T and
// V.
// Your task is to return the number of times they have to refill to write all
// the
// screen-plays.
...
// - Trivikram and Vamshi do not have enough number of papers to write
// screen-play-3
// and screen-play-4 , so they refills their boxes and finished the screenplays.
// So, the total number of times they have to refill is 0 + 0 + 1 + 1 + 0 + 0 =
// 2.
...
// Explanation:
// ------------
// - Initially, Trivikram and Vamshi have 9 papers and 7 papers each in their
// boxes.
...
public class PaperRefill {
    public static void main(String[] args) {
        ...
        System.out.println(countRefills(screenplay, t, v));

        sc.close();
    }

    private static int countRefills(int[] play, int t, int v) {
        int n = play.length;
        int l = 0, r = n - 1;
        int maxT = t, maxV = v;
